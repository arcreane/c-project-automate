    ...
    public class Cash : PaymentMethod
    {
        ...
        public override bool Pay(decimal price)
        {
            ...
            do
            {
                ...
                {
                    case "1":
                        Console.WriteLine("Veuillez insérer une ou plusieurs pièce de 5, 10, 20, 50 centimes, 1 ou 2 euro (séparé par espace)");
                ...
                if (total > price * 100)
                {
                    Console.WriteLine("Veuillez récupérer votre monnaie {0} euro", (total - price * 100) / 100);
                    return true;
                }
